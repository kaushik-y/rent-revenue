...
<head>
    ...
    <title>Admin - agent pendding Booking</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Agent Pendding Booking
                                    <div class="page-title-subheading">Here You Can Mannage agent Pendding Booking.
                                    </div>
                                </div>
                            </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/BookingController/agentpenddingbookingview/<?php echo $item->bookingid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">More
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/BookingController/approvebookingagent/<?php echo $item->bookingid; ?>/Y';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-success">Approve
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/BookingController/approvebookingagent/<?php echo $item->bookingid; ?>/R';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-warning">Rejected
                                    </button>
									</th>
                                </tr>
                                <?php } ?>
