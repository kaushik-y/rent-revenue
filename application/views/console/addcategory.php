                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add Category
                                    <div class="page-title-subheading">Here,You Can Add New Category.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/console/CategoryController/insertcat">
									                                        
										<div class="position-relative row form-group"><label for="exampleCategory" class="col-sm-2 col-form-label"><center>Category Name</center></label>
                                            <div class="col-sm-9"><input name="txtname" id="txtname" placeholder="Enter Category Name" type="text" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleImage" class="col-sm-2 col-form-label"><center>Image</center></label>
                                            <div class="col-sm-9"><input name="txtimage" id="txtimage" placeholder="Select Image" accept="image/*" type="file" class="form-control"></div>
                                        </div>
