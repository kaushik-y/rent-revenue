...
<head>
    ...
    <title> Booking User report</title>
...
<script>
		...
		var barChartData = {
			...
			while($month < $end)
			{
				$result=$this->db->query("select * from tbl_booking where DATE_FORMAT(bookingdate,'%m%Y')='".date('mY', $month)."'");
