                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add Area
                                    <div class="page-title-subheading">Here,You Can Add Area.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/console/AreaController/insertarea">
										...
										<div class="position-relative row form-group"><label for="examplePassword" class="col-sm-2 col-form-label"><center>Area Name</center></label>
                                            <div class="col-sm-9"><input name="txtname" id="txtname" placeholder="Enter state" type="text" class="form-control"></div>
                                        </div>
