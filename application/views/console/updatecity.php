                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Update City
                                    <div class="page-title-subheading">Here,You Can Update City.
                                    </div>
                                </div>
                            </div>
                               </div>
						   ...
						   <div class="mb-12 card text-white bg-dark">
							...
							<?php	}
								...
								?>
								 ...
								 <form id="form1" class="" method="post" action="<?php echo base_url(); ?>index.php/console/CityController/updatedata/<?php echo $item->cityid; ?>">
										...
										<div class="position-relative row form-group"><label for="exampleCity" class="col-sm-2 col-form-label"><center>State Name</center></label>
											...
											<select name="txtstate" id="txtstate" class="form-control">
												...
												<?php
												foreach($statedata as $item1)
												{
												?>
												<option <?php if($item1->stateid==$item->stateid) {?> selected <?php } ?> value="<?php echo $item1->stateid; ?>"><?php echo $item1->statename; ?></option>
												<?php } ?>
											</select>
											</div>
                                        </div>             
                                        
										<div class="position-relative row form-group"><label for="Cityname" class="col-sm-2 col-form-label"><center>City Name</center></label>
                                            <div class="col-sm-9"><input value="<?php echo $item->cityname; ?>" name="txtname" id="txtname" placeholder="Enter City Name" type="text" class="form-control"></div>
                                        </div>
