...
<head>
    ...
    <title>Add FAQ Category Page</title>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" method="post" action="<?php echo base_url(); ?>index.php/console/FAQCategoryController/insertcat">
									                                        
										<div class="position-relative row form-group"><label for="exampleFAQCategoryName" class="col-sm-2 col-form-label"><center>FAQ Category Name</center></label>
                                            <div class="col-sm-9"><input name="txtfaqname" id="txtfaqname" placeholder="Enter FAQCategory Name" type="text" class="form-control"></div>
                                        </div>
										<hr class="mt-4 mb-3"/>
                                            ...
                                            <div class=" offset-sm-8"/>
                                               <button  type="submit" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-warning btn-lg">Submit
												...
												<button type="button" onclick="window.location='<?php echo base_url(); ?>index.php/console/FAQCategoryController/index';" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-danger btn-lg">Cancel
                                                </button>
