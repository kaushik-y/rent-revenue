...
<head>
    ...
    <title>Admin - User New Property</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>User New Property
                                    <div class="page-title-subheading">Here You Can Mannage New Property.
                                    </div>
                                </div>
                            </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/usernewpropertyview/<?php echo $item->propertyid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">More
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/approvepropertyuser/<?php echo $item->propertyid; ?>/Y';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-success">Approve
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/approvepropertyuser/<?php echo $item->propertyid; ?>/R';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-warning">Rejected
                                    </button>
							 </th>
                                </tr>
                                <?php } ?>
...
<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
			...
			<form method="post" action="<?php echo base_url(); ?>index.php/console/PropertyController/deleteproperty/">
