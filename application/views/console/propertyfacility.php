                    ...
                    <div class="app-page-title">
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
								...
								<?php
								$count=1;
									foreach($propertyfacilitydata as $item)
								{
									?>
                                <tr>
									<td><?php echo $count; $count++;?></td>
                                    <td><?php  echo $item->propertyfacilityid;?></td>
                                    <td><?php  echo $item->propertyid;?></td>
                                    <td><?php  echo $item->facilityid;?></td>
                                    <th class="text-center">
									<button data-id="<?php echo $item->propertyfacilityid; ?>" data-toggle="modal" data-target=".bd-example-modal-sm" class="open-delete mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-danger">Delete
                                            </button>
...
<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
			...
			<form method="post" action="<?php echo base_url(); ?>index.php/console/PropertyFacilityController/deletepropertyfacility">
