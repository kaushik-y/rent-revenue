...
<head>
    ...
    <title>Add Property Facility Page</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add Facility
                                    <div class="page-title-subheading">Here,You Can Add New Property Facility.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/console/FacilityController/insertfacility">
									                                        
										<div class="position-relative row form-group"><label for="exampleFacility" class="col-sm-2 col-form-label"><center>Facility Name <span class="star">*</span></center></label>
                                            <div class="col-sm-9"><input name="txtname" id="txtname" placeholder="Enter Facility Name" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group "><label for="exampleIsActive" class="col-sm-2 col-form-label"><center>IsActive</center></label>
                                         ...
                                         <div class="position-relative row form-group"><label for="exampleImage" class="col-sm-2 col-form-label"><center>Image</center></label>
                                            <div class="col-sm-9"><input name="txtimage" id="txtimage" placeholder="Select A Image" accept="image/*" type="file" class="form-control"></div>
                                        </div>
										 <div class="position-relative row form-check">
                                             <div class=" offset-sm-8">
                                               <button  type="submit" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-warning btn-lg">Submit
												...
												<button type="button" onclick="window.location='<?php echo base_url(); ?>index.php/console/FacilityController/index';" name="btncancel" id="btncancel" class="btn-wide mb-2 mr-2 btn btn-danger btn-lg">Cancel
                                                </button>
											</div>
                                        </div>
                                </form>
...
$(document).ready(function(){
	...
	$('#form1').validate({
		...
		messages:
		{
			...
			txtimage:
			{
				required:"Pelase Select Image",
				extension:"Only jpg/jpeg/png File Allow."
			}
		}
