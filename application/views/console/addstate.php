                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add State
                                    <div class="page-title-subheading">Here,You Can Add State.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								...
								<?php }}?>
								 ...
								 <form id="form1"class="" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/console/StateController/insertstate">
									                                        
										<div class="position-relative row form-group"><label for="exampleStateName" class="col-sm-2 col-form-label"><center>State Name</center></label>
                                            <div class="col-sm-9"><input name="txtname" id="txtname" placeholder="Enter state Name" type="text" class="form-control"></div>
                                        </div>
