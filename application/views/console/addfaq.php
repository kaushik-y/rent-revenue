                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add FAQ
                                    <div class="page-title-subheading">Here,You Can Add New FAQ.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" method="post" action="<?php echo base_url(); ?>index.php/console/FAQController/insertcat">
										<div class="position-relative row form-group"><label for="examplefaq" class="col-sm-2 col-form-label"><center>FAQ Category Name</center></label>
                                            <div class="col-sm-9">
											<select name="txtfaq" id="txtfaq" class="form-control">
												<option value="">Please Select FAQ</option>
												<?php
												foreach($faqcatdata as $item)
												{
												?>
												<option value="<?php echo $item->faqcategoryid; ?>"><?php echo $item->faqcategoryname; ?></option>
												<?php } ?>
											</select>
											</div>
                                        </div>    
										<div class="position-relative row form-group"><label for="exampleQuestion" class="col-sm-2 col-form-label"><center>Question</center></label>
                                            <div class="col-sm-9"><input name="txtque" id="txtque" placeholder="Enter Your Question" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="exampleAnswer" class="col-sm-2 col-form-label"><center>Answer</center></label>
                                            <div class="col-sm-9"><input name="txtans" id="txtans" placeholder=" Enter Your Answer" type="text" class="form-control"></div>
                                        </div>
										<hr class="mt-4 mb-3"/>
                                            ...
                                            <div class=" offset-sm-8"/>
                                               <button  type="submit" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-warning btn-lg">Submit
												...
												<button type="button" onclick="window.location='<?php echo base_url(); ?>index.php/console/FAQController/index';" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-danger btn-lg">Cancel
                                                </button>
