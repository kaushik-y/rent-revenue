...
<head>
    ...
    <title>Admin - Reject Property</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Agent Reject Property Details
                                    <div class="page-title-subheading">Here You Can Mannage Rejected Property.
                                    </div>
                                </div>
                            </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/rejectpropertyview/<?php echo $item->propertyid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">More
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/rejectpropertyagentsingle/<?php echo $item->propertyid; ?>/Y';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-success">Approve
                                    </button>
							 </th>
                                </tr>
                                <?php } ?>
