...
<head>
    ...
    <title>Admin NewPropertyView</title>
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            ...
                            <div>New Property Details
								<div class="page-title-subheading">Here You Can Mannage New Property.</div>
                            </div>
                        </div>
                    </div>
                </div>     
                                            ...
                                            <li class="list-group-item">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        <div class="widget-content-left center-elem mr-2"><i class="pe-7s-angle-right text-muted fsize-2"></i></div>
                                                        <div class="widget-content-left">
                                                             <div class="widget-heading"><h6><b>Agent Name :</b></h6></div>
															<h6><?php echo $row->agentname; ?></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
											...
											<li class="list-group-item">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        <div class="widget-content-left center-elem mr-2"><i class="pe-7s-angle-right text-muted fsize-2"></i></div>
                                                        <div class="widget-content-left">
															<div class="widget-heading"><h6><b></b></h6></div>
