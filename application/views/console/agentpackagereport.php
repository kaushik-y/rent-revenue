...
<head>
    ...
    <title> Agent package Report</title>
		...
		var config = {
			...
			data: {
				datasets: [{
					data: [
						<?php
						$result=$this->db->query("select *,(select count(*) from tbl_agentpackage where packageid=tbl_package.packageid) as totalagentpackage from tbl_package");
						foreach($result->result() as $row)
						{
						?>
						<?php echo $row->totalagentpackage; ?>,
						<?php } ?>
					],
					backgroundColor: [
