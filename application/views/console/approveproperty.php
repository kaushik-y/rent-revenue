...
<head>
    ...
    <title>Admin - agentApproveProperty</title>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/approvepropertyview/<?php echo $item->propertyid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">More
                                    </button>
