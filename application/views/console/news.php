                                ...
                                <div class="d-inline-block dropdown">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a href="<?php echo base_url('/index.php/console/NewsController/addnews'); ?>"class="nav-link">
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									{
										?>
										<button onclick="window.location='<?php echo base_url(); ?>index.php/console/NewsController/changestatus/<?php echo $item->newsid; ?>/<?php echo $item->isactive; ?>';" class="mb-2 mr-2 btn-pill btn-hover-shine btn btn-success">ACTIVE
                                            </button>
										<?php
									}
									else
									{?>
										<button onclick="window.location='<?php echo base_url(); ?>index.php/console/NewsController/changestatus/<?php echo $item->newsid; ?>/<?php echo $item->isactive; ?>';" class="mb-2 mr-2 btn-pill btn-hover-shine btn btn-danger">INACTIVE
                                            </button>
									<?php }
									?></td>
									...
									<button data-id="<?php echo $item->newsid; ?>" data-toggle="modal" data-target=".bd-example-modal-sm" class="open-delete mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-danger">Delete
                                            </button>
											<button onclick="window.location='<?php echo base_url(); ?>index.php/console/NewsController/updatenews/<?php echo $item->newsid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-primary">Edit
                                            </button>
									</th>
                                </tr>
								<?php } ?>
