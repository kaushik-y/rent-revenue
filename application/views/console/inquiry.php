                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Inquiry
                                    <div class="page-title-subheading">Here You Can Mannage Your Inquiry.
                                    </div>
                                </div>
                            </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<td><?php  echo $item->inquirytext;?></td>
									<td><?php  echo $item->inquirydate;?></td>
									<td><?php  echo $item->status;?></td>
                                    <th class="text-center">
									<button data-id="<?php echo $item->inquiryid; ?>" data-toggle="modal" data-target=".bd-example-modal-sm" class="open-delete mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-danger">Delete
                                            </button>
...
<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
			...
			<form method="post" action="<?php echo base_url(); ?>index.php/console/InquiryController/deleteinquiry/">
