...
<head>
    ...
    <title>Update Property Facility Page</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Update Property Facility 
                                    <div class="page-title-subheading">Here,You Can Update Property Facility.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								...
								?>
								 ...
								 <form id="form1" class="" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/console/FacilityController/updatedata/<?php echo $item->facilityid;?>">
									                                        
										<div class="position-relative row form-group"><label for="exampleFacilityName" class="col-sm-2 col-form-label"><center>Facility Name</center></label>
                                            <div class="col-sm-9"><input value="<?php echo $item->facilityname; ?>" name="txtname" id="txtname" placeholder="facility name" type="text" class="form-control"></div>
                                        </div>
                                        ...
                                        </div><td><img src="<?php echo base_url(); ?>uploads/<?php echo $item->image;?>" width="150" height="150"/></td>
