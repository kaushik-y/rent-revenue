...
<head>
    ...
    <title>Admin - User approve Property</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>User Approve Property
                                    <div class="page-title-subheading">Here You Can Mannage Approved Property.
                                    </div>
                                </div>
                            </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/userapprovepropertyview/<?php echo $item->propertyid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">More
                                    </button>
									<button  onclick="window.location='<?php echo base_url(); ?>index.php/console/PropertyController/approvepropertyusersingle/<?php echo $item->propertyid; ?>/R';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-warning">Rejected
                                    </button>
							 </th>
                                </tr>
                                <?php } ?>
