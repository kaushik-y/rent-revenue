                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>City
                                    <div class="page-title-subheading">Here You Can Mannage Your City.
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-inline-block dropdown">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a href="<?php echo base_url('/index.php/console/CityController/addcity'); ?>"class="nav-link">
						...
						<?php
                            ...
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
									...
									<button data-id="<?php echo $item->cityid; ?>" data-toggle="modal" data-target=".bd-example-modal-sm" class="open-delete mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-danger">Delete
                                            </button>
											<button onclick="window.location='<?php echo base_url(); ?>index.php/console/CityController/updatecity/<?php echo $item->cityid; ?>';" class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-primary">Edit
                                            </button>
									</th>
                                </tr>
								<?php } ?>
...
<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
			...
			<form method="post" action="<?php echo base_url(); ?>index.php/console/CityController/deletecity">
