...
<head>
    ...
    <title>Update FAQ Category Page</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Update FAQ Category
                                    <div class="page-title-subheading">Here,You Can Update Category.
                                    </div>
                                </div>
                            </div>
                        </div>
                   ...
                   <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php
								...
								{
								?>
								 <form id="form1" class="" method="post" action="<?php echo base_url(); ?>index.php/console/FAQCategoryController/update/<?php echo $item->faqcategoryid; ?>">
									                                        
										<div class="position-relative row form-group"><label for="exampleCategoryName" class="col-sm-2 col-form-label"><center>FAQ Category Name</center></label>
                                            <div class="col-sm-9"><input value="<?php echo $item->faqcategoryname; ?>"  name="txtfaqname" id="txtfaqname" placeholder="Enter Category" type="text" class="form-control"></div>
                                        </div>
										<hr class="mt-4 mb-3"/>
                                            ...
                                            <div class=" offset-sm-8"/>
                                               <button  type="submit" name="btnsubmit" id="btnsubmit" class="btn-wide mb-2 mr-2 btn btn-warning btn-lg">Update
												...
												<button type="button" onclick="window.location='<?php echo base_url(); ?>index.php/console/FAQCategoryController/index';" name="btncancel" id="btncancel" class="btn-wide mb-2 mr-2 btn btn-danger btn-lg">Cancel
                                                </button>
                                    </form>
								<?php }?>
                                </div>
