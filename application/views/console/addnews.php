                ...
                <div class="app-main__inner">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
									<form id="form1" class=""  enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/console/NewsController/insertdata">
                                       
                                        <div class="position-relative row form-group"><label for="exampleTitle" class="col-sm-2 col-form-label">Title</label>
                                            <div class="col-sm-10"><input name="txttitle" id="txttitle" placeholder="Enter Title" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="exampleImage" class="col-sm-2 col-form-label">Image</label>
                                            <div class="col-sm-10"><input name="txtimage" id="txtimage" placeholder="Select Image" accept="image/*" type="file" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="exampleDescription" class="col-sm-2 col-form-label">Description</label>
                                           <div class="col-sm-10"><textarea name="txtdesc" id="txtdesc" placeholder="Enter Description" class="form-control"></textarea></div>
                                        </div> 
										<div class="position-relative row form-group"><label for="exampleISActive" class="col-sm-2 col-form-label">IsActive</label>
                                           <div class="form-check ml-3">
                                                    <input type="radio" name="txtisactive" class="form-check-input" value="Y" checked="">
                                                    <label class="form-check-label" for="exampleRadios1">
                                                       YES
                                                    </label>
                                                </div>
											  <div class="form-check ml-2">
                                                    <input type="radio" name="txtisactive" class="form-check-input" value="N" checked="">
                                                    <label class="form-check-label " for="exampleRadios1">
                                                       NO
                                                    </label>
                                                </div>
										   ...
										   <div class="position-relative row form-check">
                                            <div class=" offset-sm-8">
												...
												<button type="button" onclick="window.location='<?php echo base_url(); ?>index.php/console/NewsController/index';" name="btncancel" id="btncancel" class="btn-wide mb-2 mr-2 btn btn-danger btn-lg">Cancel
                                                </button>
                                            </div>
                                        </div>
									</form>
