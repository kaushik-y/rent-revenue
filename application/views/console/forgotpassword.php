...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/pages-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2019 09:09:33 GMT -->
                            ...
                            <div class="slick-slider">
                                ...
                                <div>
                                    <div class="h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="position-relative slide-img-bg" style="background-image: url('<?php echo base_url('public') ?>/assets/images/originals/citynights.jpg');"></div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                        <div class="slide-img-bg opacity-6" style="background-image: url('<?php echo base_url('public') ?>/assets/images/originals/citydark.jpg');"></div>
