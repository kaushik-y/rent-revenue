                                ...
                                <div class="mdc-card property-item grid-item column-3">
                                    ...
                                    <div class="property-content-wrapper"> 
                                        <div class="property-content">
                                            <div class="content">
                                                <h1 class="title"><a href="#"><?php echo $row->title;?></a></h1>
                            ...
                            <div class="swiper-wrapper">      
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/aloha.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/dream.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/congrats.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide"> 
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/best.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/original.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/retro.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/king.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/love.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/the.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div> 
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/easter.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/with.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/special.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="<?php echo base_url(); ?>client/assets/images/others/transparent-bg.png" alt="slide image" data-src="<?php echo base_url(); ?>client/assets/images/clients/bravo.png" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>  
                                </div> 
                            </div> 
