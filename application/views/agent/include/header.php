                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                                ...
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading"><?php echo $this->session->userdata("agentdata")->agentname; ?>
                                                                </div>
                                                                
                                                            </div>
                                                            <div class="widget-content-right mr-2">
                                                                <button onclick="window.location='<?php echo base_url(); ?>index.php/agent/LoginController/Logout';" class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="scroll-area-xs" style="height: 80px;">
                                            <div class="scrollbar-container ps">
                                                <ul class="nav flex-column"> 
                                                    <li class="nav-item">
                                                        <a href="<?php echo base_url('/index.php/agent/MyProfileController/index'); ?>" class="nav-link">Edit Profile
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<?php echo base_url('/index.php/agent/ChangePasswordController/index'); ?>" class="nav-link">Change Password
                                                        </a>
                                                    </li>
