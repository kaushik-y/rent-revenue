                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add Property
                                    <div class="page-title-subheading">Here,You Can Add New Property.
                                    </div>
                                </div>
                            </div>
                               </div>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
							...
							<?php	}
								?>
								 ...
								 <form id="form1" class="" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/agent/PropertyController/insertproperty">
										...
										<div class="position-relative row form-group"><label for="examplePackageName" class="col-sm-2 col-form-label"><center>Title<span class="star">*</span> </center></label>
                                            <div class="col-sm-9"><input name="txttitle" id="txttitle" placeholder="Enter Title Name" type="texttitle" class="form-control"></div>
                                        </div>
                                       <div class="position-relative row form-group"><label for="exampleDescription" class="col-sm-2 col-form-label"><center>Description</center></label>
                                           <div class="col-sm-9"><textarea name="txtdesc" id="txtdesc" placeholder="Enter Description" class="form-control"></textarea></div>
                                        </div> 
										 <div class="position-relative row form-group"><label for="exampleSquareFeet" class="col-sm-2 col-form-label"><center>Square Feet</center></label>
                                            <div class="col-sm-9"><input name="txtsquarefeet" id="txtsquarefeet" placeholder="Enter Square Feet" type="number" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="examplePrice" class="col-sm-2 col-form-label"><center>Day Rent</center></label>
                                            <div class="col-sm-9"><input name="txtdayrent" id="txtdayrent" placeholder="Enter Price" type="text" class="form-control"></div>
                                        </div>
										 <div class="position-relative row form-group"><label for="examplePrice" class="col-sm-2 col-form-label"><center>Full Rent</center></label>
                                            <div class="col-sm-9"><input name="txtfullrent" id="txtfullrent" placeholder="Enter Price" type="number" class="form-control"></div>
                                        </div>
										 <div class="position-relative row form-group"><label for="examplePrice" class="col-sm-2 col-form-label"><center>Sell</center></label>
                                            <div class="col-sm-9"><input name="txtsell" id="txtsell" placeholder="Enter Price" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Bed Rooms</center></label>
                                            <div class="col-sm-9"><input name="txtbedroom" id="txtbedroom" placeholder="Enter BedRooms " type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Hall</center></label>
                                            <div class="col-sm-9"><input name="txthall" id="txthall" placeholder="Enter A Hall" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Kitchen</center></label>
                                            <div class="col-sm-9"><input name="txtkitchen" id="txtkitchen" placeholder="Enter Kitchen" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Other Rooms</center></label>
                                            <div class="col-sm-9"><input name="txtotherroom" id="txtotherroom" placeholder="Enter other Rooms " type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Balcony</center></label>
                                            <div class="col-sm-9"><input name="txtbalcony" id="txtbalcony" placeholder="Enter Balcony" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Bathrooms</center></label>
                                            <div class="col-sm-9"><input name="txtbathroom" id="txtbathroom" placeholder="Enter Bathrooms" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Address</center></label>
                                            <div class="col-sm-9"><input name="txtaddress" id="txtaddress" placeholder="Enter Address" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>LandMark</center></label>
                                            <div class="col-sm-9"><input name="txtlandmark" id="txtlandmark" placeholder="Enter LandMark" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Pincode</center></label>
                                            <div class="col-sm-9"><input name="txtpincode" id="txtpincode" placeholder="Enter Pincode" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Latitude</center></label>
                                            <div class="col-sm-9"><input name="txtlatitude" id="txtlatitude" placeholder="Enter Latitude" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Longtitude</center></label>
                                            <div class="col-sm-9"><input name="txtlongtitude" id="txtlongtitude" placeholder="Enter Longtitude" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Possession</center></label>
                                            <div class="col-sm-9"><input name="txtpossessionby" id="txtpossessionby" placeholder="Enter PossessionBy" type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Total Floor</center></label>
                                            <div class="col-sm-9"><input name="txttotalfloor" id="txttotalfloor" placeholder="Enter Total Floor" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Property On Floor</center></label>
                                            <div class="col-sm-9"><input name="txtpropertyonfloor" id="txtpropertyonfloor" placeholder="Enter Property On Floor" type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>OverLooking</center></label>
                                            <div class="col-sm-9"><input name="txtoverlooking" id="txtoverlooking" placeholder="Enter OverLooking " type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Number Of Guest</center></label>
                                            <div class="col-sm-9"><input name="txtnoofguest" id="txtnoofguest" placeholder="Enter Number Of Guest " type="number" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Video</center></label>
                                            <div class="col-sm-9"><input name="txtVideo" id="txtVideo" placeholder="Enter video path " type="text" class="form-control"></div>
                                        </div>
										<div class="position-relative row form-group"><label for="example" class="col-sm-2 col-form-label"><center>Image</center></label>
                                            <div class="col-sm-9"><input name="userfile[]" id="userfile" placeholder="Enter Image " type="file" multiple="multiple" class="form-control"></div>
                                        </div>
										...
										<div class="position-relative row form-group "><label for="exampleISActive" class="col-sm-2 col-form-label"><center>Furniture</center></label>
                                           <div class="form-check">
                                                    <input type="radio" name="txtfurniture" class="form-check-input  ml-2" value="Y" checked="">
                                                    <label class="form-check-label  ml-4 "  for="exampleRadios1">
                                                       <h6>YES</h6>
                                                    </label>
                                                </div>
											  <div class="form-check ml-2">
                                                    <input type="radio" name="txtfurniture" class="form-check-input  ml-8 " value="N" checked="">
